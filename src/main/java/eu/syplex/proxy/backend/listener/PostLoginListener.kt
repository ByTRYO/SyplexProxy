...
class PostLoginListener(private val notifier: Notifier, private val playerTracker: PlayerTracker, private val translator: ComponentTranslator) {

    @Subscribe
    fun onPostLogin(event: PostLoginEvent) {
        val player = event.player
        val proxyPlayer = ProxyPlayer(player, notifier, translator)
